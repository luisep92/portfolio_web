---
title: saas_template
summary: A full-stack SaaS starter — FastAPI + PostgreSQL + Next.js, with auth, AI chat, usage tiers, audit log, Docker and CI. Built as modules you delete rather than a monolith you inherit. Extracted from two applications that had independently ended up with the same skeleton.
tier: featured
order: 5
year: 2026
role: Solo author
