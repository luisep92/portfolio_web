...
El driver fue interno: hacía 30+ consultas a FModel por sesión para [el boss fight de Aline](/es/projects/aline-boss-fight), y el loop manual de GUI me destrozaba el ritmo. El MCP expone las operaciones que Claude realmente necesita — browse, search, export por clase, dump de materiales — y convierte los "5 minutos por consulta" en una tool call.
