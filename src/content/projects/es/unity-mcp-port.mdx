...
El upstream `CoplayDev/unity-mcp` declara Unity 2021.3+ y depende de C# 8/9, UI Toolkit, y APIs que no existen en 2019.4. El fork mantiene los commits cherry-pickables para poder proponer piezas de vuelta al upstream, pero la working copy targetea el mundo de modding de BS 1.34.2 limpiamente.
